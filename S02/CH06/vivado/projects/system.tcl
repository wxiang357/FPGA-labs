...
proc create_root_design { parentCell } {
  ...
  set SW2 [ create_bd_port -dir I -from 0 -to 0 SW2 ]
  ...
  connect_bd_net -net Op1_1 [get_bd_ports SW1] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net Op1_1_1 [get_bd_ports SW2] [get_bd_pins util_vector_logic_1/Op1]
