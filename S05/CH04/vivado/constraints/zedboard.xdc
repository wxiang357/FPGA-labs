...
# VGA
set_property PACKAGE_PIN Y21  [get_ports {vga_pBlue_0[0]}];  # "VGA-B1"
set_property PACKAGE_PIN Y20  [get_ports {vga_pBlue_0[1]}];  # "VGA-B2"
set_property PACKAGE_PIN AB20 [get_ports {vga_pBlue_0[2]}];  # "VGA-B3"
set_property PACKAGE_PIN AB19 [get_ports {vga_pBlue_0[3]}];  # "VGA-B4"
set_property PACKAGE_PIN AB22 [get_ports {vga_pGreen_0[0]}];  # "VGA-G1"
set_property PACKAGE_PIN AA22 [get_ports {vga_pGreen_0[1]}];  # "VGA-G2"
set_property PACKAGE_PIN AB21 [get_ports {vga_pGreen_0[2]}];  # "VGA-G3"
set_property PACKAGE_PIN AA21 [get_ports {vga_pGreen_0[3]}];  # "VGA-G4"
set_property PACKAGE_PIN V20  [get_ports {vga_pRed_0[0]}];  # "VGA-R1"
set_property PACKAGE_PIN U20  [get_ports {vga_pRed_0[1]}];  # "VGA-R2"
set_property PACKAGE_PIN V19  [get_ports {vga_pRed_0[2]}];  # "VGA-R3"
set_property PACKAGE_PIN V18  [get_ports {vga_pRed_0[3]}];  # "VGA-R4"
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pBlue_0[*]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pGreen_0[*]}]
set_property IOSTANDARD LVCMOS33 [get_ports {vga_pRed_0[*]}]

set_property PACKAGE_PIN AA19 [get_ports {vga_pHSync_0}];  # "VGA-HS"
set_property PACKAGE_PIN Y19  [get_ports {vga_pVSync_0}];  # "VGA-VS"
